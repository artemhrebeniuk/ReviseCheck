        ...
        <div className="max-w-4xl mx-auto flex h-14 items-center justify-between gap-4 rounded-full border border-gray-200 bg-white/85 backdrop-blur-xl shadow-sm px-5 pointer-events-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <a href="/" className="text-base sm:text-[17px] font-bold tracking-tight text-gray-900 hover:text-gray-600 transition">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {telemetry && (
              <div className="flex items-center gap-1.5 sm:gap-2 bg-gray-50 border border-gray-200 rounded-full px-3 py-1 text-sm shadow-2xs">
            ...
            >
              <svg width="15" height="15" className="w-4 h-4 shrink-0 fill-gray-500" viewBox="0 0 24 24">
          ...
          <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-900 text-base sm:text-lg">Engine Configuration</h3>
              </div>
              <button
            ...
            <div className="pt-2 flex items-center justify-between">
              <span className="text-xs sm:text-sm text-gray-500 font-mono inline-flex items-center gap-1">
                {isSaved ? (
                  <>
